...
class MdaReportTest {
    ...
    void toJson(){
        ...
        MdaReport mdaReport = new MdaReport(data);
        String json = mdaReport.toJson();
        assert json.equals("{\"firstName\":\"Garfield\",\"lastName\":\"Sapseed\",\"idType\":0," +
                ...
                "\"barcode\":\"21ABBA1C-1292-5EB2-0BBA-7C4AB5DB1185\",\"takeDate\":\"4/7/2021\"}");
    }
}