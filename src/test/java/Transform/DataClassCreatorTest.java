...
import Transform.DataClass.Factory.DataClassFactory.MdaReportFactory;
...
class DataClassCreatorTest {
    ...
    void createDataClass() {
        ...
        DataClassCreator dataClassCreator = new DataClassCreator(new HashMap<String, DataClassFactory>(){{put("MdaReport", new MdaReportFactory());}});
        MdaReport mdaReport = (MdaReport) dataClassCreator.createDataClass("MdaReport", data);
